function [ presource_calib,xx,yy ] = prop_scat_holo_spot( focus_depth,scat_array,xcor,ycor)

%prop_scat_holo_spot Propagation of the light field through the scatterers
...
%   through the scatterers array.
    global N dxy wvl NA spot_radius dz Nz

%% define units
    dp                                 =  2*pi/dxy/N;                      % spatial frequency pixel
    k                                   =  2*pi/wvl;                       % wavevector [um-1]
